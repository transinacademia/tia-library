原文选自：Keegan, C.M. (2018). Getting Disciplined: What’s Trans* about Queer Studies Now? Journal of Homosexuality, 67(3), pp.1–14. doi.org/10.1080/00918369.2018.1530885.
本文于2018年线上出版，刊登出版于2020年。
...
小注：“sexuality”在本文大部分翻译为“性意识”，但读者完全可以理解为“性”、”性存在“、“性取向”等等；“experiences”翻译为“经验”或“经历”；“pattern”，“mode”，“schema”全翻译为“模式”；sex 只译为“性”、gender 只译为“性别”；当 trans 独立使用时翻译为“跨儿”，其它情况下翻译为“跨性/别”；transgender 译为“跨性别”； transsexual 译为“跨性”；woman 译为“女人”
...
摘要（Abstract）：这篇文章绘制了跨儿*研究（trans* studies）可能面临的认识论领域（the epistemological terrain），因为它正被广泛地被收编到（incorporated into）酷儿研究项目中，通常被安置在女人研究部门（women’s studies departments）内。在过去的二十年里，酷儿研究和女人研究迅速专业化（professionalized），产生了学科/规训权力的新模式（new modes of disciplinary power），这些模式可能试图包括或引用跨儿*研究（include or cite trans* studies），但往往不完全欢迎其具体的物质和政治投入（specific material and political investments）。在这种境况下，跨儿*研究可能会发现自己在很大程度上被当作一种但是（a but）——一种知识障碍（an epistemic blockage），一种从合适对象转移的干扰（a distraction from proper objects），一种对惯习通常方法的阻碍（a hindrance to customary methods）——而必须被加以规训（must be disciplined）。



关键词（Keywords）：跨性别（transgender）；跨儿*研究（trans* studies）；规训/学科（discipline）；酷儿研究；LGBTQ 研究；女性主义；女人研究（women’s studies）
...
介词（prepositi on）
（1）除了；除……之外；不同于 （except; apart from; other than）
副词（adverb）
（1）仅仅；只有（no more than; only）
名词（noun）
（1）反对某事的论据；反对。
...
参考文献：
Ahmed, S. (2014). On being included: Racism and diversity in institutional life. Durham, NC: Duke University Press. 
Ahmed, S. (2016). An affinity of hammers. Transgender Studies Quarterly, 3(1–2), 22–34. doi:10.1215/23289252-3334151
Ahmed, S. (2017, August 9). A complaint biography [blog post]. Retrieved from https://feministkilljoys.com/2017/08/09/a-complaint-biography/ 
Awkward-Rich, C. (2017). Trans, feminism: Or, reading like a depressed transsexual. Signs, 42(4), 819–841. doi:10.1086/690914 
Barthes, R. (1972). Jeunes chercheurs. Communications, 19, 1–5. doi:10.3406/comm.1972.1276 
Berlant, L. (2011). Cruel optimism. Durham, NC: Duke University Press.
Bettcher, T. M. (2013). Trapped in the wrong theory: Rethinking trans oppression and resistance. Signs, 39(2), 383–406. doi:10.1086/673088 
Brown, W. (2005). Edgework: Critical essays on knowledge and politics. Princeton, NJ: Princeton University Press. 
Butler, J. (1994). Against proper objects. Differences: A Journal of Feminist and Cultural Studies, 6(2–3), 1–26. 
Eng, D. L., Halberstam, H., & Munoz, J. E. (2005). Introduction: What’s queer about queer studies now? Social Text, 23(3–4), 2–18. doi:10.1215/01642472-23-3-4_84-85-1 
Hale, J. (1997). Suggested rules for non-transsexuals writing about transsexuals, transsexuality, transsexualism, or trans [blog post]. Retrieved from www.sandystone.com/hale.rules.html 
Halley, J. (2006). Split decisions: How and why to take a break from feminism. Princeton, NJ: Princeton University Press. 
Jeffreys, S. (2014). Gender hurts: A feminist analysis of the politics of transgenderism. New York, NY: Routledge. 
Love, H. (2014). Queer. Transgender Studies Quarterly, 1(1–2), 172–176. doi:10.1215/23289252-2399938
Malatino, H. (2015). Pedagogies of becoming: Trans inclusivity and the crafting of being. Transgender Studies Quarterly, 2(3), 395–410. doi:10.1215/23289252-2926387 
Namaste, V. (2000). Invisible lives: The erasure of transgendered and transsexual people. Chicago, IL: University of Chicago Press. 
...
Noble, B. (2012). Trans. Panic. Some thoughts toward a theory of feminist fundamentalism. In F. Enke (Ed.), Transfeminist perspectives in and beyond transgender and gender studies (pp. 45–59). Philadelphia, PA: Temple University Press.
...
Prosser, J. (1998). Second skins: The body narratives of transsexuality. New York, NY: Columbia University Press.
Salamon, G. (2010). Assuming a body: Transgender and rhetorics of materiality. New York, NY: Columbia University Press.
Schor, N., & Weed, E. (Eds.). (1997). Feminism meets queer theory. Bloomington, IN: Indiana University Press.
Shraya, V. (2016). Even this page is white. Vancouver, BC: Arsenal Pulp Press.
Spade, D. (2006). Mutilating gender. In S. Stryker & S. Whittle (Eds.), The transgender studies reader (Vol. 1, pp. 315–332). New York, NY: Routledge.
Spivak, G. (1996). Bonding in difference: An interview with Alfred Arteaga (1993-94). In D. Landry & G. MacLean (Eds.), The Spivak reader (pp. 15–28).New York, NY: Routledge.
Steinbock, E. (2017). Framing stigma in trans* mediascapes: How does it feel to be a problem? Spectator, 37(2), 48–57.
Steinmetz, K. (2014, May 29). The transgender tipping point [web article]. Time. Retrieved from http://time.com/135480/transgender-tipping-point/ 
Stryker, S. (2004). Transgender studies: Queer theory’s evil twin. GLQ: A Journal of Lesbian and Gay Studies, 10(2), 211–215. doi:10.1215/10642684-10-2-212
Stryker, S., & Bettcher, T. M. (2016). Introduction: Trans/feminisms. Transgender Studies Quarterly, 3(1–2), 5–14. doi:10.1215/23289252-3334127
Tompkins, A. (2014). Asterisk. Transgender Studies Quarterly, 1(1–2), 26–27. doi:10.1215/23289252-2399497
Wallach Scott, J. (Ed.). (2008). Women’s studies on the edge. Durham, NC: Duke University Press.
Weigman, R. (Ed.). (2002). Women’s studies on its own: A next wave reader in institutional change. Durham, NC: Duke University Press.
Wiegman, R., & Wilson, E. A. (2015). Introduction: Antinormativity’s queer conventions. Differences: A Journal of Feminist Cultural Studies, 26(1), 1–25. doi:10.1215/10407391-2880582
Wilchins, R. A. (2006). What does it cost to tell the truth? In S. Stryker & S. Whittle (Eds.), The Transgender studies reader (Vol. 1, pp. 547–551). New York, NY: Routledge.
1 在本文中，我用跨儿（trans）来表示一套抵抗般的性别化/性化身份认同（resistantly gendered/sexed identifications），这包括着跨性别（transgender）和跨性（transsexual），而我用跨儿*（trans*）来表示一种更广泛的形成（a broader formation），包括着历史上由跨性/别人群（trans populations）创造的理论、文化生产、政治想象、身体、和物质实践（the theories, cultural productions, political imaginaries, bodies, and material praxes）。我在这里对星号的使用是与《跨性别研究季刊（Transgender Studies Quarterly）》创刊号中的《星号（“asterisk”）》条目一致，艾弗里·汤普金斯（Avery Tompkins 2014年）在该条目文章中描述了星号的功能，即在一套分散独立的身份（a set of discrete identities）之外，“来为跨性别（transgender）或跨儿（trans）敞开更大范围的意义”（第26页）。星号还表明，对跨儿（trans）的假定指称（the presumed referent）并没有稳定下来（not settled）：虽然 女人和性别研究（WGS）和  LGBTQ/queer 研究 等较早的领域已经发展出更多根深蒂固的、中心化的，同时每个领域都在努力解构/取代（deconstruct/displace）的，指称（例如，称为“女人 women ”的东西和称为“基和蕾丝边 gay and lesbian”的东西），但对于跨儿（trans）的指称对象（the referred object）来说，并没有明确的领域特定的共识（field-specific consensus）。因此，跨儿*（trans *）表明了一种不稳定的境况（an unsettled condition），它反映了关于谁算是一个跨儿主体（a trans subject）的在历史上的种族化、阶级化、和性别化的社群内部政治（historically racialized, classed, and gendered intracommunity politics），同时也指出了跨学科理论阐述（interdisciplinary theoretical elaboration.）的一系列未确定的潜力（a range of undetermined potentials）。
