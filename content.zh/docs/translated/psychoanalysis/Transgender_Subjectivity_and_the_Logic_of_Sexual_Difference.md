...
> “使我们将这种满足与性感带的自我情欲所区分开来的是一个对象，我们经常将这个对象与驱力在其上闭合的对象混淆起来。这个对象只是一个空洞的在场，是一片虚空，它是可以被占据的，弗洛伊德告诉我们，任何对象都可以去占据那个空洞，我们将之作为遗失的对象即**对象小a**（the petit a）的代理。对象小a不是口唇驱力的起源。它并不是作为原初食物，而是通过这一事实被引入：除了绕过那个永恒匮乏的对象（eternally lacking object），没有任何食物能够满足口唇驱力。”（*Four* 179–80）
